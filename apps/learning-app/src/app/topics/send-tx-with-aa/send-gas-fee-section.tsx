  ...
  return (
    <section className="w-full">
      ...
      <p className="p-2 pb-4 text-lg text-muted-foreground">
        Let's make one last preparation for sending tx. Maybe your wallet is still empty. This means
        you can't even pay for gas. So let's send some money to your wallet.
      </p>
